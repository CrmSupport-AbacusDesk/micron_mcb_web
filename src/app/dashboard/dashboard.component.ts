...
export class DashboardComponent implements OnInit {
  ...
  users: any = {};
    ...
    get_counts() 
    {
        ...
        state_wise_karigar()
        {
            ...
            .subscribe((resp)=>
            {
                ...
                {
                    this.karigar_state_wise.push({"label": this.stateWiseKarigar[i].country,"value": this.stateWiseKarigar[i].total_karigars});
                }
        ...
        state_wise_dealer(){
            ...
            .subscribe((resp)=>
            {
                ...
                {
                    this.dealer_state_wise.push({"label": this.stateWiseDealer[i].country,"value": this.stateWiseDealer[i].total_retailer});
                }
    ...
    countshowKarigarList=true;
    countshowDealersList=false;
    countshowKarigar(){
        console.log("click");
        this.countshowKarigarList=true;
        this.countshowDealersList=false;
        this.country_wise_karigars();
    }
    countshowDealers(){
        this.countshowDealersList=true;
        this.countshowKarigarList=false;
        this.country_wise_dealers();
    }

    countryWisekarigar:any=[];
    country_wise_karigars(){
        this.db.post_rqst({},'master/stateWiseKarigar')
        .subscribe((resp)=>
        {
            console.log(resp);
            this.countryWisekarigar=resp.state_wise_karigars;
    ...
    countryWiseDealer:any=[];
    country_wise_dealers(){
        this.db.post_rqst({},'master/stateWiseKarigar')
        .subscribe((resp)=>
        {
            console.log(resp);
            this.countryWiseDealer=resp.state_wise_Retailer;
