...
export class CouponCodeListComponent implements OnInit {
    ...
    exportKarigarCouponList()
    {
        ...
        .subscribe( d => {
            this.loading_list = false;
            document.location.href = this.db.myurl+'app/uploads/exports/scanned-by-electrician.csv';
            console.log(d);
        });
    }
    exportRetailerCouponList()
    {
        ...
        .subscribe( d => {
            this.loading_list = false;
            document.location.href = this.db.myurl+'app/uploads/exports/scanned-by-dealer.csv';
            console.log(d);
        });
    }
